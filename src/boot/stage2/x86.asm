...
;
; CDECL convention
; Args: Stack RTL. Caller removes args from stack 
; Return: int, or ptr -> EAX. float -> ST0
; Registers: EAX, ECX, EDX saved by caller. Rest saved by callee 
;
...
_x86_Video_WriteCharTeletype:
  ...
  ; [bp + 0] - old call frame
  ; [bp + 2] - return address (near call so 16 bit offset -> 2 bytes)
  ; [bp + 4] - char (bytes get resized to WORD)
  ; [bp + 6] - page 
  mov ah, 0Eh
  mov al, [bp + 4]
  mov bh, [bp + 6]
